...
\newcommand{\CVTitle}{Dan's CV for DeepMind}
\newcommand{\CVNote}{CV compiled on {\today} for DeepMind}
...
{\underline{\smash{D. Magee}} and K. Niemeyer,
...
{\underline{\smash{D. Magee}} and K. Niemeyer,
	``Accelerating solutions of PDEs with GPU-based swept time-space decomposition,''
	 In preparation, \DatestampYM{2017}{05}}
